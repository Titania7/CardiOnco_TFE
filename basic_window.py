...
#%% Options Menu
    ...
    def optionMenuPopUp(self):
        ...
        optionMenu.exec()
        self.txt_meta.setText("Identifier : "+self.name+" ; Sex : "+ self.sex+" ; Age : "+str(self.age)+" years ; Weight : "+ str(self.weight)+ " kg ; Height : "+ str(self.height)+" m")        
        ...
        if file_name:
            ...
            if len(file_name) == 1:
                ...
                if extension == "json"  and "meta" in list(data.keys()):
                    ...
                    txt_meta = QLabel("Identifier : "+self.name+" ; Sex : "+ self.sex+" ; Age : "+str(self.age)+" years ; Weight : "+ str(self.weight)+ " kg ; Height : "+ str(self.height)+" m")
                    self.layout.addWidget(txt_meta)
                    self.splitter.addWidget(txt_meta)
